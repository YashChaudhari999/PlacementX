...
export default function StudentDashboard() {
  ...
  const stats: StatCard[] = [
    { label: 'Active Drives', value: drives.length, icon: 'briefcase', color: '#4F46E5', bg: '#EEF2FF' },
    { label: 'Applications', value: applications.length, icon: 'document-text', color: '#0891B2', bg: '#E0F2FE' },
    { label: 'Offers Received', value: placed, icon: 'checkmark-circle', color: '#16A34A', bg: '#DCFCE7' },
  ];
      ...
      >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/(student)/drives')}>
