...
> = {
 ...
 iconBg: 'bg-warning-muted border border-amber-200',
 badge: 'Incomplete',
 ...
 icon: Clock01Icon,
 iconColor: 'text-info',
 iconBg: 'bg-info-muted border border-blue-200',
 ...
 iconBg: 'bg-destructive-muted border border-red-200',
...
export const ProfileUnderReview = () => {
 ...
 >
 {/* Card */}
 <div className="bg-card/80 backdrop-blur-xl border border-white shadow-2xl shadow-slate-200/50 rounded-3xl overflow-hidden">
 {/* Top stripe */}
 ...
 {/* Steps */}
 <div className="bg-muted rounded-2xl border border-border p-5 mb-8">
 ...
 ${isDone ? 'bg-emerald-100 text-success' : 'bg-slate-200 text-muted-foreground'}`}
 >
 {isDone ? <TickDouble02Icon className="w-4 h-4"/> : i + 1}
 </div>
 <span
 className={`text-sm font-medium ${isDone ? 'text-emerald-700 line-through' : 'text-foreground'}`}
 >
 {step.label}
 </span>
 </div>
 ...
 className="flex items-center justify-center gap-2 px-5 py-3.5 bg-muted hover:bg-slate-200 text-foreground font-semibold rounded-2xl transition-all text-sm"
 >
 ...
 <span className="inline-flex items-center gap-2 text-xs text-muted-foreground bg-card/60 backdrop-blur border border-border/60 px-3 py-1.5 rounded-full">
