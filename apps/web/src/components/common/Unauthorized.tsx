...
export const Unauthorized = () => (
 ...
 <div className="w-24 h-24 bg-destructive-muted rounded-full flex items-center justify-center mx-auto mb-6 border-8 border-red-50/50 shadow-sm">
 <Shield02Icon className="w-10 h-10 text-destructive"/>
 </div>
