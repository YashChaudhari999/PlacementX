...
export default function AdminProfileVerifications() {
 ...
 <p className="text-sm text-muted-foreground">Review and verify new student profiles</p>
 </div>
 </div>

 <div className="bg-card rounded-2xl shadow-sm border border-border overflow-hidden">
 <div className="p-4 border-b border-border flex flex-col sm:flex-row gap-4 items-center bg-muted/50">
 ...
 className="w-full pl-10 pr-4 py-2 rounded-xl border border-border text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20"
 />
 </div>
 </div>
 ...
 <td className="px-6 py-4 text-muted-foreground">{profile.branch}</td>
 <td className="px-6 py-4 text-muted-foreground">{profile.cgpa}</td>
 <td className="px-6 py-4 text-right">
 <Button
 size="sm"
 variant="outline"
 onClick={() => setSelectedProfile(profile)}
 className="gap-2 text-info hover:text-blue-700 hover:bg-info-muted"
 >
 ...
 <h2 className="text-xl font-bold text-foreground">Review Profile</h2>
 ...
 <div className="text-foreground">{selectedProfile.user?.email}</div>
 </div>
 <div>
 <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">
 Phone
 </div>
 <div className="text-foreground">{selectedProfile.phone || 'N/A'}</div>
 </div>
 <div>
 <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">
 Branch
 </div>
 <div className="text-foreground">{selectedProfile.branch || 'N/A'}</div>
 </div>
 <div>
 <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">
 Current Semester
 </div>
 <div className="text-foreground">{selectedProfile.currentSemester || 'N/A'}</div>
 </div>
 <div>
 <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">
 CGPA
 </div>
 <div className="text-foreground">{selectedProfile.cgpa || 'N/A'}</div>
 </div>
 <div>
 <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">
 Passing Year
 </div>
 <div className="text-foreground">{selectedProfile.passingYear || 'N/A'}</div>
 </div>
 <div>
 <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">
 Active Backlogs
 </div>
 <div className="text-foreground">{selectedProfile.activeBacklogs || '0'}</div>
 </div>
 <div>
 <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">
 Total Backlogs
 </div>
 <div className="text-foreground">{selectedProfile.totalBacklogs || '0'}</div>
 </div>
 <div>
 <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">
 10th %
 ...
 <div className="text-foreground">{selectedProfile.yearGap || '0'}</div>
 </div>
 ...
 className="w-full h-24 p-3 rounded-xl border border-border text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20"
 />
 </div>
 </div>
 ...
 className="bg-destructive-muted text-destructive hover:bg-red-100 hover:text-red-700 border-none"
 >
