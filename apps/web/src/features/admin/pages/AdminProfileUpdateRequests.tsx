...
export default function AdminProfileUpdateRequests() {
 ...
 if (isLoading)
 return (
 <div className="p-8 text-center text-muted-foreground font-medium">Loading update requests...</div>
 );
 ...
 <div>
 <h1 className="text-2xl font-bold text-foreground">Profile Update Requests</h1>
 <p className="text-sm text-muted-foreground">Review changes requested by verified students</p>
 </div>
 </div>
 ...
 <div className="text-xs text-muted-foreground">{req.student?.user?.email}</div>
 </td>
 ...
 className="bg-card rounded-3xl shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col max-h-[90vh]"
 >
 <div className="p-6 border-b border-border">
 <h2 className="text-xl font-bold text-foreground">Review Update Request</h2>
 ...
 <div className="bg-info-muted border border-blue-100 rounded-xl p-4">
 ...
 <tr>
 <th className="px-4 py-3 font-medium text-muted-foreground w-1/3">Field</th>
 <th className="px-4 py-3 font-medium text-muted-foreground w-1/3">
 Current Value
 </th>
 <th className="px-4 py-3 font-medium text-info w-1/3">
 Requested Value
 </th>
 </tr>
 </thead>
 ...
 <td className="px-4 py-3 text-info font-medium break-all">
 {requestedRendered}
 </td>
 </tr>
 );
