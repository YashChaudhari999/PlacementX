...
export default function AdminStudentProfile() {
 ...
 <button className="p-2 text-muted-foreground hover:text-muted-foreground hover:bg-muted rounded-full transition-colors">
 ...
 {/* Main content tabs */}
 <Card className="bg-card/80 backdrop-blur-sm border border-border shadow-sm overflow-hidden">
