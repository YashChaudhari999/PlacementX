...
export default function AdminCalendar() {
 ...
 <div className="hidden md:flex items-center gap-2 text-xs font-semibold text-success bg-success-muted px-4 py-2 rounded-xl border border-emerald-100 shadow-sm">
 ...
 <div className="bg-card/80 backdrop-blur-xl rounded-3xl border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 md:p-8 h-[850px] calendar-wrapper relative overflow-hidden group/calendar">
