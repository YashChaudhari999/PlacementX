...
import { useAdminCalendar, useUpdateCustomEvent, useRescheduleInterview } from '@/hooks/queries/useAdminCalendar';
...
export default function AdminCalendar() {
  ...
  const handleEventChange = (changeInfo: any) => {
    ...
    if (isCustom) {
      ...
      const time = event.startStr.includes('T') ? event.startStr.split('T')[1].substring(0, 5) : undefined;
      ...
      >
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-black text-slate-800 tracking-tight">Placement Calendar</h1>
          </div>
          <p className="text-slate-500 text-base max-w-2xl">Orchestrate placement drives, track academic schedules, and manage interviews effortlessly with this interactive command center.</p>
        </div>
