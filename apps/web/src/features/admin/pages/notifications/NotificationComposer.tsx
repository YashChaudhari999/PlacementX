        ...
        <Card className="p-6 border-slate-200 shadow-sm min-h-[400px]">
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <label
                    key={opt.id}
                    className={`flex items-start gap-3 p-4 border rounded-xl cursor-pointer transition-colors ${formData.audienceType === opt.id ? 'border-indigo-600 bg-indigo-50/50' : 'border-slate-200 hover:border-indigo-300 hover:bg-slate-50'}`}
                  >
                    <input
                      type="radio"
                      name="audienceType"
          ...
          {step === 3 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
              ...
              <div className="space-y-4">
                <label
                  className={`flex items-start gap-4 p-5 border rounded-xl cursor-pointer transition-colors ${formData.channels.inApp ? 'border-indigo-600 bg-indigo-50/50' : 'border-slate-200 hover:border-indigo-300'}`}
                >
                  <input
                    type="checkbox"
                  ...
                  <div className="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2 py-1 rounded border border-emerald-200">
                    Recommended
                  </div>
                </label>

                <label
                  className={`flex items-start gap-4 p-5 border rounded-xl cursor-pointer transition-colors ${formData.channels.push ? 'border-indigo-600 bg-indigo-50/50' : 'border-slate-200 hover:border-indigo-300'}`}
                >
                  <input
                    type="checkbox"
                    className="mt-1 w-5 h-5 text-indigo-600 border-slate-300 rounded focus:ring-indigo-600"
                ...
                <label
                  className={`flex items-start gap-4 p-5 border rounded-xl cursor-pointer transition-colors ${formData.channels.email ? 'border-indigo-600 bg-indigo-50/50' : 'border-slate-200 hover:border-indigo-300 opacity-60'}`}
                >
                  <input
                    type="checkbox"
                    className="mt-1 w-5 h-5 text-indigo-600 border-slate-300 rounded focus:ring-indigo-600"
          ...
          {step === 4 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
              ...
              <div className="grid grid-cols-2 gap-4">
                <label
                  className={`flex flex-col items-center justify-center p-6 border rounded-xl cursor-pointer transition-colors text-center gap-2 ${formData.scheduleType === 'now' ? 'border-indigo-600 bg-indigo-50/50 text-indigo-700' : 'border-slate-200 hover:border-indigo-300 text-slate-600'}`}
                >
                  <input
                    type="radio"
                    name="scheduleType"
                ...
                <label
                  className={`flex flex-col items-center justify-center p-6 border rounded-xl cursor-pointer transition-colors text-center gap-2 ${formData.scheduleType === 'later' ? 'border-indigo-600 bg-indigo-50/50 text-indigo-700' : 'border-slate-200 hover:border-indigo-300 text-slate-600'}`}
                >
                  <input
                    type="radio"
                    name="scheduleType"
