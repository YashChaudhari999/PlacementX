...
export default function NotificationInbox() {
 ...
 {isLoading ? (
 <div className="p-8 text-center text-muted-foreground">Loading your notifications...</div>
 ) : isError ? (
 ...
 <div
 key={notification.id}
 className={`p-4 flex gap-4 transition-colors ${notification.isRead ? 'bg-card' : 'bg-indigo-50/20'}`}
 >
