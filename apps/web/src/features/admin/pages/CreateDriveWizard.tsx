...
export default function CreateDriveWizard() {
 ...
 {isLoading && (
 <div className="text-center py-12 text-muted-foreground">Loading drive details...</div>
 )}
 ...
 : isCurrent
 ? 'bg-card border-primary text-primary shadow-xl shadow-primary/20'
...
function Step1Company() {
 ...
 <p className="text-xs text-muted-foreground">Upload a square logo for best display results.</p>
 </div>
 ...
 <select
 {...register('industry')}
 className="w-full h-10 rounded-md border border-border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 bg-transparent"
 >
 ...
 <label className="text-sm font-medium text-foreground">Company Profile *</label>
 <textarea
 {...register('companyProfile')}
 rows={3}
 className="w-full rounded-md border border-border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 bg-transparent"
 placeholder="Brief description of the company..."
 />
 </div>
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">HR Name</label>
 <Input {...register('hrName')} placeholder="Primary contact person"/>
 </div>
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">HR Email</label>
...
function Step2Job() {
 ...
 <p className="text-muted-foreground text-sm mt-1">Role, package, and employment type specifics.</p>
 </div>
 ...
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Fixed CTC (LPA)</label>
 <Input {...register('ctc')} type="number"step="0.1"placeholder="e.g. 12.5"/>
 </div>
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Variable Pay (LPA)</label>
 <Input {...register('variablePay')} type="number"step="0.1"placeholder="e.g. 2.0"/>
 </div>
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Internship Stipend (/mo)</label>
 <Input
 ...
 <div className="col-span-2 space-y-2">
 <label className="text-sm font-medium text-foreground">Bond Details (if any)</label>
 <Input {...register('bondDetails')} placeholder="e.g. 2 years bond, 2 Lakhs penalty"/>
 </div>
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">No. of Vacancies</label>
 <Input
 {...register('vacancies')}
 type="number"
 ...
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Job Location</label>
...
function Step3Eligibility() {
 ...
 className="w-full h-32 rounded-md border border-border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 bg-transparent"
 >
 ...
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Active Backlogs Allowed</label>
 <Input {...register('activeBacklogs')} type="number"defaultValue={0} />
 </div>
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Year Gap Allowed</label>
 <Input {...register('yearGap')} type="number"defaultValue={0} />
 </div>
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Gender Restriction</label>
 <select
 ...
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Maximum Live Offers Allowed</label>
...
function Step4Registration() {
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-semibold text-foreground">Registration Timeline</h2>
 <p className="text-muted-foreground text-sm mt-1">
 ...
 <div className="relative">
 <Calendar01Icon className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground"/>
 <Input
 type="date"
 className="pl-10"
 ...
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Registration End Date *</label>
 <div className="relative">
 <Calendar01Icon className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground"/>
 <Input
 type="date"
 ...
 <div className="space-y-2 pt-4">
 <label className="text-sm font-medium text-foreground">Maximum Applicants</label>
 <Input
 type="number"
 ...
 <h3 className="text-sm font-semibold text-foreground mb-2 border-b pb-2">
 Required Documents
 </h3>
...
function Step5Selection() {
 ...
 <div>
 <h2 className="text-xl font-semibold text-foreground">Selection Process</h2>
 <p className="text-muted-foreground text-sm mt-1">Define the interview rounds and assessments.</p>
 </div>
 ...
 <div
 key={field.id}
 className="p-4 border border-border rounded-xl bg-muted relative group"
 >
 <button
 type="button"
 ...
 <h4 className="text-sm font-semibold text-foreground mb-4">Round {index + 1}</h4>
 <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
 <div className="space-y-2 col-span-2">
 <label className="text-xs font-medium text-muted-foreground">Round Title</label>
 <Input
 ...
 <label className="text-xs font-medium text-muted-foreground">Venue / Link</label>
 <Input
...
function Step6Attachments() {
 ...
 <div className="border-2 border-dashed border-border rounded-xl p-12 flex flex-col items-center justify-center text-center bg-muted hover:bg-muted transition-colors cursor-pointer">
 <div className="w-16 h-16 bg-card rounded-full flex items-center justify-center shadow-sm mb-4 text-primary">
 <Attachment01Icon className="w-8 h-8"/>
 </div>
 <h3 className="text-base font-semibold text-foreground">Drag & Drop files here</h3>
 <p className="text-sm text-muted-foreground mt-1">or click to browse from your computer</p>
 <p className="text-xs text-muted-foreground mt-4">Supported formats: PDF, PPTX, DOCX (Max 10MB)</p>
 </div>
 </div>
 );
}
...
function Step7Preview() {
 ...
 <div>
 <h2 className="text-xl font-semibold text-foreground">Preview Drive</h2>
 <p className="text-muted-foreground text-sm mt-1">
 ...
 <div className="flex-1 overflow-y-auto border border-border rounded-xl p-6 bg-muted space-y-8">
 {/* Header Preview */}
 <div className="flex items-center gap-4 border-b border-border pb-6">
 <div className="w-16 h-16 bg-card border border-border rounded-lg flex items-center justify-center text-muted-foreground">
 ...
 <p className="font-medium text-foreground">{data.workMode}</p>
 </div>
 <div>
 <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">
 Minimum CGPA
 </p>
 <p className="font-medium text-foreground">{data.minimumCgpa || 'No minimum'}</p>
 </div>
 <div>
 <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">
 Eligible Branches
 ...
 <span
 key={i}
 className="px-3 py-1.5 bg-card border border-border rounded-md text-sm font-medium text-foreground shadow-sm"
 >
 {i + 1}. {r.title || 'Round'}{' '}
 {r.date
