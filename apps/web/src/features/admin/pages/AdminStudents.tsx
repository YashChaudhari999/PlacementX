...
export default function AdminStudents() {
 ...
 return (
 <ArrowUpDownIcon className="w-3 h-3 text-muted-foreground opacity-0 group-hover/th:opacity-100 transition-opacity"/>
 );
 ...
 className="w-full h-9 pl-9 pr-8 text-sm bg-card border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-colors"
 />
 {filters.search && (
 <button
 ...
 <kbd
 className="absolute right-2.5 top-1/2 -translate-y-1/2 hidden sm:inline-block text-[10px] font-mono text-muted-foreground border border-border rounded px-1 py-0.5 pointer-events-none"
 ...
 className="h-9 pl-3 pr-8 text-xs font-medium bg-card border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20 appearance-none cursor-pointer"
 >
 ...
 <ArrowDown01Icon className="absolute right-2 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-muted-foreground pointer-events-none"/>
 </div>
 ...
 className={`h-9 px-3 text-xs font-medium border rounded-lg flex items-center gap-1.5 transition-colors ${showFilters ? 'bg-indigo-50 border-indigo-200 text-indigo-700' : 'bg-card border-border text-muted-foreground hover:bg-muted'}`}
 >
 ...
 className="h-9 px-3 text-xs font-medium text-muted-foreground hover:text-foreground flex items-center gap-1.5"
 >
 ...
 {showFilters && (
 <div className="bg-muted border border-border rounded-lg p-4 grid grid-cols-2 md:grid-cols-4 gap-4">
 <div>
 <label className="text-xs font-medium text-muted-foreground mb-1 block">Min CGPA</label>
 <input
 type="number"
 step="0.1"
 min="0"
 ...
 className="w-full h-9 px-3 text-sm bg-card border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
 />
 </div>
 <div>
 <label className="text-xs font-medium text-muted-foreground mb-1 block">Max CGPA</label>
 <input
 type="number"
 step="0.1"
 min="0"
 ...
 size="sm"
 variant="outline"
 className="text-xs bg-card text-indigo-600 hover:bg-muted border-white/20 hover:text-indigo-700"
 ...
 size="sm"
 variant="outline"
 className="text-xs bg-card/10 border-white/20 text-white hover:bg-card/20"
 ...
 <div
 className="absolute right-0 top-8 z-30 bg-card border border-border rounded-lg shadow-lg py-1 w-44"
 ...
 className="w-full text-left px-3 py-2 text-xs text-foreground hover:bg-muted flex items-center gap-2 block"
 >
 ...
 <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 py-3 border-t border-border bg-muted/50">
 ...
 className="h-8 px-2 text-xs bg-card border border-border rounded-md focus:outline-none"
 >
 ...
 className="h-8 w-8 flex items-center justify-center border border-border rounded-l-md bg-card hover:bg-muted disabled:opacity-40 disabled:cursor-not-allowed"
 aria-label="Previous page"
 >
 <ArrowLeft01Icon className="w-4 h-4 text-muted-foreground"/>
 </button>
 <span className="h-8 px-3 flex items-center text-xs font-medium text-muted-foreground border-y border-border bg-card">
 {pagination.page} / {pagination.totalPages}
 </span>
 <button
 disabled={pagination.page >= pagination.totalPages}
 onClick={() => updateFilter('page', pagination.page + 1)}
 className="h-8 w-8 flex items-center justify-center border border-border rounded-r-md bg-card hover:bg-muted disabled:opacity-40 disabled:cursor-not-allowed"
...
function DetailRow({
 ...
 <span className={`font-medium ${highlight ? 'text-amber-700' : 'text-foreground'}`}>
 {value}
 </span>
 </div>
 );
