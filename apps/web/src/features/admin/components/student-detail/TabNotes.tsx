...
export function TabNotes({
 ...
 <h3 className="font-semibold text-foreground">Internal Remarks & Notes</h3>
 ...
 id="note"
 rows={3}
 className="block w-full rounded-md border-border shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-3 border"
 ...
 <div key={idx} className="bg-warning-muted/50 border border-amber-100 rounded-lg p-4">
