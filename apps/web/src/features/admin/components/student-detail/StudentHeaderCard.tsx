...
import { UserIcon, Mail01Icon, CallIcon, MapsLocation01Icon, Mortarboard01Icon, BookOpen01Icon } from 'hugeicons-react';

export function StudentHeaderCard({ importedData, profileData }: { importedData: any, profileData: any }) {
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-5">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <Badge className={getPlacementStatusColor(importedData.placementStatus || 'Unplaced')}>
        ...
        <div className="flex gap-4 md:border-l md:border-gray-100 md:pl-6">
          <div className="text-center px-4">
            ...
            <p className="text-2xl font-bold text-gray-900">{importedData.cgpa ? importedData.cgpa.toFixed(2) : 'N/A'}</p>
          </div>
          <div className="text-center px-4 border-l border-gray-100">
            <p className="text-sm font-medium text-gray-500 mb-1">Backlogs</p>
            <p className={`text-2xl font-bold ${importedData.activeBacklogs > 0 ? 'text-red-600' : 'text-gray-900'}`}>
