...
export function GenerateHrInviteModal({ isOpen, onClose }: Props) {
 ...
 className="bg-card rounded-xl shadow-xl w-full max-w-lg overflow-hidden"
 >
 <div className="flex items-center justify-between p-6 border-b border-border">
 <h2 className="text-xl font-semibold text-foreground">Generate HR Invitation</h2>
 ...
 <div className="w-16 h-16 bg-green-100 text-success rounded-full flex items-center justify-center mx-auto">
 ...
 <Link01Icon className="w-5 h-5 text-muted-foreground shrink-0"/>
 <input
 readOnly
 value={generatedLink}
 ...
 className="p-2 hover:bg-slate-200 rounded-md transition-colors text-muted-foreground hover:text-foreground shrink-0"
 >
 {copied ? (
 <Tick01Icon className="w-4 h-4 text-success"/>
 ) : (
