...
export default function GeneralSettings({ settings, getValue, handleChange, saveChanges, hasUnsavedChanges, saving }: any) {
  return (
    <Card className="p-6">
      <div className="flex items-center justify-between mb-6 border-b border-slate-100 pb-4">
        ...
        {hasUnsavedChanges && (
          <Button onClick={() => saveChanges(['institutionName', 'supportEmail', 'academicYear'])} disabled={saving} size="sm">
