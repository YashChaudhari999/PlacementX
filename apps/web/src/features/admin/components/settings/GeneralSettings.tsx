...
export default function GeneralSettings({
 ...
 <GlobalIcon className="w-5 h-5 text-muted-foreground"/>
 <h3 className="font-bold text-foreground text-lg">General Settings</h3>
 </div>
 {hasUnsavedChanges && (
 <Button
 ...
 />
 <p className="text-xs text-muted-foreground">Visible to students in the support section.</p>
 </div>
