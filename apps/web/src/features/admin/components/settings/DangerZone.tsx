...
export default function DangerZone() {
 ...
 <Alert01Icon className="w-5 h-5 text-destructive"/>
 <h3 className="font-bold text-red-700 text-lg">Danger Zone</h3>
 </div>

 <div className="space-y-6">
 <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-destructive-muted rounded-xl border border-red-100">
 <div className="mb-4 sm:mb-0">
 <h4 className="text-sm font-bold text-red-800">Archive Academic Year</h4>
 <p className="text-xs text-destructive mt-1 max-w-lg">
