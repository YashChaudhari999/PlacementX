...
export default function PlacementSettings({
 ...
 <h3 className="font-bold text-foreground text-lg">Placement Rules</h3>
 </div>
 {hasUnsavedChanges && (
 <Button
 ...
 <label className="text-sm font-medium text-foreground">Max Applications Per Student</label>
 <Input
 type="number"
 min={1}
 ...
 <div>
 <h4 className="text-sm font-medium text-foreground">Allow Multiple Offers</h4>
