...
export default function ReportBuilder() {
 ...
 <div className="bg-warning-muted dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 rounded-lg p-4 flex mt-6">
 <Alert02Icon className="h-5 w-5 text-warning mr-3 flex-shrink-0"/>
 ...
 {!historyId ? (
 <>
 <div className="w-20 h-20 bg-blue-100 text-info rounded-full flex items-center justify-center mx-auto mb-6">
 ...
 >
 <Note01Icon className="mr-2 h-4 w-4 text-success"/> Excel
 </Button>
 <Button
 variant="outline"
 className="w-full"
 ...
 disabled={generating || !!historyId}
 >
 <Note01Icon className="mr-2 h-4 w-4 text-info"/> CSV
 </Button>
 <Button
 variant="outline"
 className="w-full"
 ...
 disabled={generating || !!historyId}
 >
 <Note01Icon className="mr-2 h-4 w-4 text-destructive"/> PDF
 </Button>
 </div>
