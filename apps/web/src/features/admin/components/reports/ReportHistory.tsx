...
export default function ReportHistory() {
 ...
 if (format === 'EXCEL') return <Note01Icon className="h-4 w-4 text-success"/>;
 if (format === 'PDF') return <Note01Icon className="h-4 w-4 text-destructive"/>;
 return <Note01Icon className="h-4 w-4 text-info"/>;
 };
