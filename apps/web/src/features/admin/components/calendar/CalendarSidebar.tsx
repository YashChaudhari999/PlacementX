...
export default function CalendarSidebar({ events, summary, onDateSelect }: CalendarSidebarProps) {
 ...
 className="bg-card/80 backdrop-blur-2xl rounded-[24px] border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.06)] p-6 overflow-hidden relative group"
 >
 ...
 className="mx-auto flex justify-center text-sm font-semibold text-foreground relative z-10"
 showOutsideDays
 />
 </motion.div>
 ...
 <motion.div
 variants={itemVariants}
 className="bg-card/80 backdrop-blur-2xl rounded-[24px] border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.06)] p-6"
 >
 <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-5 flex items-center gap-2">
 <SparklesIcon className="w-4 h-4 text-warning"/> Quick Snapshot
 </h3>
 ...
 <div className="text-3xl font-black text-success tracking-tight group-hover:scale-105 transition-transform origin-left">
 ...
 <div className="text-center py-6 text-sm text-muted-foreground font-medium bg-muted/50 rounded-2xl border border-dashed border-border">
 No upcoming events
 </div>
 ) : (
 ...
 key={event.id || idx}
 variants={itemVariants}
 className="group flex gap-4 p-3 -mx-3 rounded-[16px] hover:bg-muted/80 transition-all cursor-pointer relative overflow-hidden hover:shadow-sm"
 >
 <div
 ...
 <div className="text-sm font-bold text-foreground truncate group-hover:text-indigo-600 transition-colors">
 {event.title}
 </div>
 ...
 className="absolute right-3 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-card shadow-sm border border-border flex items-center justify-center opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-indigo-600 hover:border-indigo-100 transition-all transform translate-x-2 group-hover:translate-x-0"
 >
 ...
 >
 <div className="absolute top-0 right-0 w-32 h-32 bg-card/20 rounded-full blur-2xl -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-700"></div>
 ...
 <div
 key={idx}
 className="bg-card/10 hover:bg-card/20 backdrop-blur-sm p-4 rounded-[16px] transition-colors cursor-pointer border border-white/10"
 >
