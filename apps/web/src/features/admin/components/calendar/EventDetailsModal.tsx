...
export default function EventDetailsModal({ event, onClose, onEdit }: EventDetailsModalProps) {
 ...
 <button
 onClick={onClose}
 className="relative z-10 p-1 text-white/80 hover:text-white hover:bg-card/20 rounded-full transition-colors"
 >
 ...
 <div>
 <div className="text-sm font-semibold text-foreground">Location / Platform</div>
 <div className="text-sm text-muted-foreground mt-0.5">{extendedProps.venue}</div>
 </div>
 </div>
 )}
 ...
 <div className="text-sm text-muted-foreground mt-0.5">{extendedProps.company}</div>
 </div>
 </div>
 )}
 ...
 <div className="text-sm text-muted-foreground mt-0.5 whitespace-pre-wrap leading-relaxed">
 {extendedProps.description}
 </div>
 </div>
 </div>
 ...
 className="p-2 text-destructive hover:bg-destructive-muted rounded-xl transition-colors"
 title="Delete Event"
 >
 ...
 <button
 onClick={onClose}
 className="px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-slate-200 bg-muted rounded-xl transition-colors"
 >
 Close
 </button>
