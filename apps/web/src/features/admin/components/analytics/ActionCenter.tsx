...
export default function ActionCenter({ data }: { data: ActionCenterResponse }) {
 ...
 <p className="text-xs text-muted-foreground">Prioritized recommendations requiring attention</p>
 </div>
 </div>
 ...
 : 'bg-warning-muted border-amber-200 hover:bg-amber-100/50'
 }`}
 >
 <div className="flex items-start gap-3">
 <div
 className={`mt-0.5 shrink-0 ${isCritical ? 'text-rose-600' : 'text-warning'}`}
 >
 {isCritical ? (
 ...
 : 'text-warning hover:text-amber-700'
 }`}
 >
