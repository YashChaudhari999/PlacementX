          ...
          return (
            ...
            >
              <div className="flex items-start gap-3">
                <div className={`mt-0.5 shrink-0 ${isCritical ? 'text-rose-600' : 'text-amber-600'}`}>
              ...
              <div className="shrink-0 sm:self-stretch flex sm:flex-col justify-between sm:justify-center items-center sm:items-end border-t sm:border-t-0 sm:border-l border-current/10 pt-3 sm:pt-0 sm:pl-4">
                ...
                {action.category !== 'OPERATIONS' && (
                  <button className={`inline-flex items-center gap-1 text-sm font-bold transition-colors ${
                    isCritical ? 'text-rose-600 hover:text-rose-700' : 'text-amber-600 hover:text-amber-700'
                  }`}>
