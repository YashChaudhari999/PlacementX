...
export default function PackageDistribution({ packages }: { packages: any }) {
 ...
 <div className="mb-6">
 <h3 className="text-lg font-bold text-foreground">Package Distribution</h3>
 ...
 <span className="text-xs font-bold text-muted-foreground mt-3 text-center whitespace-nowrap truncate w-full px-1">
 {label}
 </span>
 </div>
 );
 ...
 {previousDist && (
 <div className="mt-6 flex justify-center gap-6 text-sm font-medium text-muted-foreground">
