...
export default function YearComparisonChart({ data }: { data: YearComparisonRow[] }) {
 ...
 <div className="p-2 bg-blue-100 rounded-xl text-info">
 <Calendar01Icon className="w-5 h-5"/>
 </div>
 <div>
 <h2 className="text-lg font-bold text-foreground">Year-over-Year Trends</h2>
 <p className="text-xs text-muted-foreground">Historical performance comparison</p>
 </div>
 </div>
 ...
 className="px-3 py-1.5 text-xs font-bold text-emerald-700 bg-success-muted border border-emerald-200 rounded-lg outline-none cursor-pointer"
 >
