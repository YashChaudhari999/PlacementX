...
const ChartWrapper = ({
 ...
 ? 'fixed inset-0 z-50 bg-card p-8 overflow-auto flex flex-col'
 ...
 <div ref={chartRef} className="flex-1 w-full bg-card relative">
 {children}
 </div>
 </Card>
 );
...
export default function AnalyticsCharts({
 ...
 <ChartWrapper
 title="Department-wise Placed Students (YoY Comparison)"
 ...
 dataKey="prevPlaced"
 fill="#94a3b8"
 name="Previous Year Placed"
 radius={[4, 4, 0, 0]}
 />
 <Bar
 dataKey="currPlaced"
 fill="#3b82f6"
 name="Current Year Placed"
 radius={[4, 4, 0, 0]}
 />
 </BarChart>
 </ResponsiveContainer>
