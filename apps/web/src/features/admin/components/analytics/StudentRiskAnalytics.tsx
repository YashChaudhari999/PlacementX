...
export default function StudentRiskAnalytics({ data }: { data: StudentRiskResponse }) {
 ...
 <Card className="p-4 border-emerald-200 bg-success-muted/50">
 <div className="text-xs font-bold text-success uppercase tracking-wider mb-1">
 High Readiness
 </div>
 ...
 <Card className="p-4 border-blue-200 bg-info-muted/50">
 ...
 <Card className="p-4 border-amber-200 bg-warning-muted/50">
 ...
 <h3 className="font-bold text-foreground">Profile Readiness</h3>
 </div>
 ...
 <div className="text-xs text-muted-foreground">Missing Resume</div>
 </div>
 </div>
 <div className="flex items-center gap-3">
 ...
 <div>
 <div className="text-lg font-bold text-foreground">{profileReadiness.pending}</div>
 ...
 <div>
 <div className="text-lg font-bold text-foreground">{profileReadiness.complete}</div>
 ...
 <h3 className="font-bold text-foreground">Priority Intervention List</h3>
 <span className="text-xs font-bold px-2.5 py-1 bg-muted text-muted-foreground rounded-lg">
 ...
 <span className="text-[10px] px-1.5 py-0.5 bg-warning-muted text-warning rounded">
 Not Verified
 </span>
 )}
 </div>
 </td>
 <td className="px-6 py-4 text-muted-foreground">{student.department || 'N/A'}</td>
 <td className="px-6 py-4">
