...
const severityStyles: Record<InsightSeverity, string> = {
 ...
 MEDIUM: 'bg-warning-muted border-amber-200 text-amber-800',
 LOW: 'bg-muted border-border text-foreground',
 POSITIVE: 'bg-success-muted border-emerald-200 text-emerald-800',
...
export default function PlacementIntelligence({ data }: { data: InsightsResponse }) {
 ...
 <div>
 <h2 className="text-lg font-bold text-foreground">Placement Intelligence</h2>
 <p className="text-xs text-muted-foreground">Automated insights and anomaly detection</p>
 </div>
 </div>
 ...
 <span className="px-2 py-1 bg-muted text-muted-foreground text-xs font-bold rounded-lg">
 {summary.total} Total
 </span>
 </div>
 </div>
