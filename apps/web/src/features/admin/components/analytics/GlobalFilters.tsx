...
export default function GlobalFilters() {
 ...
 {/* Academic Year */}
 <select
 className="px-3 py-2 text-sm font-medium bg-muted border border-border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none min-w-[140px]"
 ...
 {/* Department */}
 <select
 className="px-3 py-2 text-sm font-medium bg-muted border border-border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none min-w-[160px]"
 ...
 {/* Placement Status */}
 <select
 className="px-3 py-2 text-sm font-medium bg-muted border border-border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none min-w-[120px]"
 ...
 <select
 className="w-full px-3 py-2 text-sm bg-muted border border-border rounded-xl outline-none"
 ...
 <input
 type="text"
 className="w-full px-3 py-2 text-sm bg-muted border border-border rounded-xl outline-none placeholder:text-muted-foreground"
