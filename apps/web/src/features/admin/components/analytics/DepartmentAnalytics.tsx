...
export default function DepartmentAnalytics({ data }: { data: DepartmentResponse }) {
 ...
 <div>
 <h2 className="text-lg font-bold text-foreground">Department Intelligence</h2>
 <p className="text-xs text-muted-foreground">Performance across academic branches</p>
 </div>
 </div>
 <div className="text-right">
 <div className="text-sm font-bold text-foreground">{data.institutionRate.toFixed(1)}%</div>
 <div className="text-xs text-muted-foreground">Inst. Avg Rate</div>
 </div>
 </div>
 ...
 <tr>
 <th
 className="px-4 py-3 rounded-l-xl cursor-pointer hover:bg-muted transition-colors"
 ...
 <th
 className="px-4 py-3 rounded-r-xl cursor-pointer hover:bg-muted transition-colors"
 ...
 return (
 <tr key={dept.department} className="hover:bg-muted/50 transition-colors group">
 <td className="px-4 py-4 font-bold text-foreground">{dept.department}</td>
 <td className="px-4 py-4 text-muted-foreground">
 <div>{dept.totalStudents}</div>
 <div className="text-[10px] text-muted-foreground">{dept.placedStudents} placed</div>
 </td>
 <td className="px-4 py-4">
 <div className="flex items-center gap-2">
 <div
 className={`font-black ${isBelowAvg ? 'text-rose-600' : 'text-foreground'}`}
 >
 ...
 <div
 className={`text-[10px] font-bold ${dept.packageChange > 0 ? 'text-success' : 'text-rose-500'}`}
 >
