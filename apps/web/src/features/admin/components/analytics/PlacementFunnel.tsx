...
export default function PlacementFunnel({ data }: { data: FunnelResponse }) {
 ...
 return (
 <Card className="p-6 border-border flex flex-col items-center justify-center min-h-[300px] text-muted-foreground">
 ...
 <div>
 <h2 className="text-lg font-bold text-foreground">Application Funnel</h2>
 <p className="text-xs text-muted-foreground">Conversion across selection stages</p>
 </div>
 </div>

 {data.insight?.largestDrop && (
 <div className="mb-6 p-4 bg-warning-muted rounded-xl border border-amber-200 flex gap-3 items-start">
 <Alert01Icon className="w-5 h-5 text-warning shrink-0 mt-0.5"/>
 <div>
 ...
 <div className="absolute -top-5 left-10 flex items-center gap-2 text-[10px] font-bold text-muted-foreground">
