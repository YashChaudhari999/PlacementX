...
export default function CompanyAnalytics({ data }: { data: CompanyResponse }) {
 ...
 <div className="p-2 bg-amber-100 rounded-xl text-warning">
 <Building02Icon className="w-5 h-5"/>
 </div>
 <div>
 <h2 className="text-lg font-bold text-foreground">Recruiter Intelligence</h2>
 <p className="text-xs text-muted-foreground">Top hiring companies and retention rates</p>
 </div>
 </div>
 ...
 <ArrowUp01Icon className="w-3 h-3 text-success"/>
 </div>
 <div className="text-[10px] text-muted-foreground uppercase tracking-wider">Returning</div>
 </div>
 <div className="text-center">
 <div className="text-sm font-bold text-foreground flex items-center justify-center gap-1">
 {retention.newCount}
 ...
 <div className="text-[10px] text-muted-foreground uppercase tracking-wider">Lost</div>
 </div>
 </div>
 )}
 </div>
 ...
 className="flex flex-col sm:flex-row sm:items-center gap-4 p-4 rounded-xl border border-border bg-muted hover:bg-muted/50 transition-colors"
 >
 ...
 <div>
 <h4 className="font-bold text-foreground">{company.companyName}</h4>
 ...
 <div className="font-black text-foreground">{company.offers}</div>
 </div>
