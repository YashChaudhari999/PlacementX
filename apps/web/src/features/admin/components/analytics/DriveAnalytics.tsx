...
export default function DriveAnalytics({ data }: { data: DriveAnalyticsResponse }) {
 ...
 <div className="text-2xl font-black text-foreground">{summary.totalDrives}</div>
 <div className="text-xs text-muted-foreground font-medium mt-1">
 <span className="text-success font-bold">{summary.activeDrives}</span> Active
 </div>
 </Card>
 ...
 <div className="text-xs text-muted-foreground font-medium mt-1">Across all drives</div>
 </Card>
 ...
 <div className="text-xs text-muted-foreground font-medium mt-1">Student engagement</div>
 </Card>
 ...
 <div className="text-2xl font-black text-foreground">{summary.totalOffers}</div>
 <div className="text-xs text-muted-foreground font-medium mt-1">From tracked drives</div>
 </Card>
 </div>
 ...
 <div>
 <h3 className="font-bold text-foreground">Drive Performance</h3>
 <p className="text-xs text-muted-foreground">Conversion and engagement per drive</p>
 </div>
 </div>
 ...
 <tr key={drive.id} className="hover:bg-muted/50 transition-colors">
 <td className="px-6 py-4">
 <div className="font-bold text-foreground">{drive.companyName}</div>
 ...
 <div className="flex gap-4 text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1.5">
 <div className="flex items-center gap-1">
 <UserMultipleIcon className="w-3 h-3 text-info"/> {drive.applied}
 </div>
 <div className="flex items-center gap-1">
 <TickDouble02Icon className="w-3 h-3 text-success"/> {drive.offered}
 </div>
 </div>
 ...
 <div
 className={`font-black ${drive.offerConversion > 10 ? 'text-success' : drive.offerConversion > 0 ? 'text-foreground' : 'text-muted-foreground'}`}
 >
