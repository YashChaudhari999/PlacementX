...
export default function StudentProfile() {
 ...
 <div className="absolute inset-2 rounded-full overflow-hidden bg-card flex items-center justify-center border border-border shadow-inner z-10">
 {profile.photoUrl ? (
 ...
 placeholder="CBSE"
 disabled={isReadOnly}
 className="h-12 bg-card focus:bg-card rounded-xl disabled:opacity-70 border-border"
 />
 </Field>
 ...
 variant="outline"
 size="sm"
 className="text-destructive border-red-200 hover:bg-destructive-muted"
 onClick={async () => {
 try {
 ...
 {profile.resumeUrl ? (
 <div className="flex items-center gap-3 p-3 border border-emerald-100 bg-success-muted/50 rounded-xl">
 <div className="p-2 bg-emerald-100 rounded-lg shrink-0">
 <Note01Icon className="w-5 h-5 text-success"/>
 </div>
 ...
 variant="outline"
 size="sm"
 className="h-8 w-8 p-0 text-success hover:text-emerald-700 hover:bg-emerald-100"
 onClick={(e) => {
 e.preventDefault();
 ...
 variant="outline"
 size="sm"
 className="h-8 text-xs bg-card text-muted-foreground border-border"
 disabled={uploadMutation.isPending}
 >
 {uploadMutation.isPending &&
 ...
 : 'bg-muted/50 border-border hover:border-blue-400 hover:bg-info-muted/30'
 }`}
 >
 <div
 className={`p-3 rounded-full mb-3 ${uploadMutation.isPending && uploadMutation.variables?.documentType === 'RESUME' ? 'bg-slate-200 animate-pulse' : 'bg-card shadow-sm'}`}
 >
 <CloudUploadIcon
 className={`w-6 h-6 ${uploadMutation.isPending && uploadMutation.variables?.documentType === 'RESUME' ? 'text-muted-foreground' : 'text-info'}`}
 />
 </div>
 ...
 <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1 text-success bg-success-muted px-2 py-1 rounded text-xs font-bold">
 ...
 <div
 key={idx}
 className="flex gap-4 items-end bg-muted p-4 rounded-xl border border-border"
 >
 ...
 className="h-12 px-4 text-destructive hover:text-destructive hover:bg-destructive-muted border-red-200"
 >
 <Cancel01Icon className="w-4 h-4"/>
 </Button>
 )}
 ...
 className="w-full border-dashed border-2 text-muted-foreground hover:text-foreground hover:bg-muted py-6"
 >
 ...
 className="h-12 px-4 text-destructive hover:bg-destructive-muted border-red-200 shrink-0"
 >
 <Cancel01Icon className="w-4 h-4"/>
 </Button>
 )}
 ...
 className="w-4 h-4 rounded text-info focus:ring-blue-500"
 />{' '}
 Reading
 </label>
 <label className="flex items-center gap-2 text-sm font-medium text-foreground">
 ...
 <div
 key={idx}
 className="bg-muted/80 p-6 rounded-2xl border border-border relative group"
 >
 {!isReadOnly && (
 <button
 onClick={() =>
 ...
 className="absolute top-4 right-4 p-2 bg-red-100 text-destructive rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
 >
 <Cancel01Icon className="w-4 h-4"/>
 </button>
 )}
 ...
 disabled={isReadOnly}
 className="w-full h-11 bg-card border border-border rounded-xl px-4 disabled:opacity-70"
 >
 ...
 disabled={isReadOnly}
 rows={2}
 className="w-full px-4 py-3 rounded-xl border border-border bg-card focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all disabled:opacity-70 resize-none"
 />
 </Field>
 ...
 className="w-4 h-4 rounded text-info"
 />
 ...
 disabled={isReadOnly}
 rows={3}
 className="w-full px-4 py-3 rounded-xl border border-border bg-card focus:ring-2 focus:ring-blue-500/20 disabled:opacity-70 resize-none"
 />
 </Field>
 <Field label="Achievements & Impact"icon={Award01Icon}>
 <textarea
