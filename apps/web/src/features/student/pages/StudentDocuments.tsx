      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <Card className="p-6 border-slate-200/60 shadow-lg shadow-slate-100 bg-white/90 backdrop-blur-xl hover:border-indigo-200 transition-all duration-300">
            ...
            <div
              className={`p-5 border rounded-xl flex flex-col items-center justify-center text-center transition-all ${data.academicDocuments.find((d: any) => d.documentType === 'RESUME') ? 'border-emerald-100 bg-emerald-50/50' : 'border-dashed border-slate-200 bg-slate-50/50'}`}
            >
            ...
            <div className="space-y-4">
              {[
                ...
                return (
                  <div
                    key={docDef.type}
                    className={`p-4 border rounded-xl transition-all ${uploadedDoc ? 'border-indigo-100 bg-indigo-50/30' : 'border-slate-200 bg-slate-50'}`}
                  >
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex-1 pr-2">
                        ...
                        {uploadedDoc && (
                          <span
                            className="text-[10px] text-slate-500 truncate block mt-1"
