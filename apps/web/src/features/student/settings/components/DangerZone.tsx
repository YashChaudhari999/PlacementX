...
export default function DangerZone() {
  ...
  const handleDeactivate = () => {
    if (window.confirm("Are you sure you want to request account deactivation? You will lose access to placement drives.")) {
      requestDeactivation();
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 border border-slate-200/60 shadow-lg shadow-slate-200/40 bg-white/90 backdrop-blur-xl">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-bold text-slate-800 text-lg">Export Data</h3>
            <p className="text-sm text-slate-500 mt-1 mb-4">
              Download a copy of all your personal data, including profile information, applications, and documents currently stored on PlacementX.
            </p>
      ...
      <Card className="p-6 border border-red-200 shadow-lg shadow-red-100/50 bg-red-50/30 backdrop-blur-xl">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-red-800/80 mt-1 mb-4">
              Request to deactivate your account. This will remove your access to the portal and withdraw you from all active placement drives. A placement coordinator must approve this request.
            </p>
