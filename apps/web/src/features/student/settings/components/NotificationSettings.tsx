      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <label className="flex items-center gap-3">
            <input type="checkbox" name="emailEnabled" checked={notifs.emailEnabled || false} onChange={handleChange} className="w-4 h-4 rounded border-slate-300 text-primary focus:ring-primary" />
            <span className="text-sm text-slate-600">Email Notifications</span>
          </label>
          <label className="flex items-center gap-3">
            <input type="checkbox" name="pushEnabled" checked={notifs.pushEnabled || false} onChange={handleChange} className="w-4 h-4 rounded border-slate-300 text-primary focus:ring-primary" />
        ...
        <div className="space-y-4 pt-4 border-t border-slate-100">
          ...
          {['placement', 'interviews', 'meetings', 'messages', 'assignments', 'system'].map((type) => (
        ...
        <div className="space-y-4 pt-4 border-t border-slate-100 bg-slate-50/50 p-4 rounded-xl">
          ...
          <label className="flex items-center gap-3 mb-4">
            <input type="checkbox" name="quietHoursEnabled" checked={notifs.quietHoursEnabled || false} onChange={handleChange} className="w-4 h-4 rounded border-slate-300 text-primary focus:ring-primary" />
          ...
          {notifs.quietHoursEnabled && (
            <div className="flex items-center gap-4">
              <div className="flex-1 space-y-1">
                ...
                <Input type="time" name="quietHoursStart" value={notifs.quietHoursStart || ''} onChange={handleChange} />
              </div>
              <div className="flex-1 space-y-1">
                <label className="text-xs font-medium text-slate-500">End Time</label>
                <Input type="time" name="quietHoursEnd" value={notifs.quietHoursEnd || ''} onChange={handleChange} />
              </div>
            </div>
          )}
        </div>
