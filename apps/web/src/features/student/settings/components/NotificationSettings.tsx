...
export default function NotificationSettings() {
 ...
 className="w-4 h-4 rounded border-border text-primary focus:ring-primary"
 />
 <span className="text-sm text-muted-foreground capitalize">{type} Alerts</span>
 </label>
 )
 )}
 </div>

 <div className="space-y-4 pt-4 border-t border-border bg-muted/50 p-4 rounded-xl">
 <h4 className="font-medium text-foreground">Quiet Hours</h4>
 <p className="text-sm text-muted-foreground mb-2">Mute push notifications during these hours.</p>
