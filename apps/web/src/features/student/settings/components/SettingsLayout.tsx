...
export default function SettingsLayout() {
 ...
 <h1 className="text-3xl font-extrabold text-foreground tracking-tight">Settings Center</h1>
 ...
 {/* Sidebar */}
 <Card className="w-full lg:w-72 shrink-0 p-3 bg-card/90 backdrop-blur-xl border border-border/60 shadow-lg shadow-slate-200/40 rounded-2xl sticky top-24">
