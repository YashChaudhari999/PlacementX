...
export const WorkflowTimeline = () => {
 ...
 {/* Connecting line */}
 <div className="hidden md:block absolute top-12 left-[10%] right-[10%] h-1 bg-muted rounded-full z-0 overflow-hidden">
 <motion.div
 ...
 >
 <div className="h-24 w-24 rounded-2xl bg-card border-2 border-border flex items-center justify-center mb-6 shadow-sm transition-all duration-300 group-hover:border-primary group-hover:shadow-md group-hover:-translate-y-1 relative">
