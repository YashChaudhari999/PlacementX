...
export const TestimonialsSection = () => {
 ...
 className="bg-card p-8 rounded-2xl shadow-sm border border-border flex flex-col relative"
 >
 ...
 <p className="text-foreground italic mb-8 relative z-10 flex-grow">
"{testimonial.quote}"
 </p>
