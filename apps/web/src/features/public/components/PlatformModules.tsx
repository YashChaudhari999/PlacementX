...
const modules = [
 ...
 icon: <UserCircleIcon className="h-6 w-6 text-info"/>,
 color: 'bg-info-muted',
 ...
 icon: <DashboardSquare01Icon className="h-6 w-6 text-success"/>,
 ...
 icon: <SmartPhone01Icon className="h-6 w-6 text-warning"/>,
...
export const PlatformModules = () => {
 ...
 <h3 className="text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl mb-4">
 ...
 >
 <div
 className={`p-8 lg:p-10 h-full rounded-2xl bg-card border border-border shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 overflow-hidden relative group`}
 >
 ...
 <div
 className={`shrink-0 mb-6 inline-flex p-4 rounded-xl shadow-sm border bg-card ${mod.borderColor}`}
 >
 {mod.icon}
 </div>
 <div>
 <h4 className="text-xl font-bold text-foreground mb-3">{mod.title}</h4>
