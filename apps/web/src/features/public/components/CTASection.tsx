          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white mb-6 leading-tight">
                Ready to modernize <br className="hidden sm:block" />campus placements?
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/admin/login" className="inline-flex items-center justify-center rounded-md h-14 px-10 text-base font-bold shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all bg-white text-primary hover:bg-slate-50">
                  Placement Cell Login
                </Link>
                <Link to="/student/login" className={buttonVariants({ variant: 'outline', size: 'lg' }) + " h-14 px-10 text-base font-semibold text-white border-white/30 bg-white/10 backdrop-blur-md hover:bg-white/20 hover:text-white transition-all"}>
                  Student Login
                </Link>
              </div>
            </motion.div>
