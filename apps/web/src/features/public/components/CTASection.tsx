...
export const CTASection = () => {
 ...
 <div className="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-card/10 blur-3xl"/>
 ...
 <Link
 to="/admin/login"
 className="inline-flex items-center justify-center rounded-md h-14 px-10 text-base font-bold shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all bg-card text-primary hover:bg-muted"
 >
 ...
 ' h-14 px-10 text-base font-semibold text-white border-white/30 bg-card/10 backdrop-blur-md hover:bg-card/20 hover:text-white transition-all'
 }
 >
 Student Login
 </Link>
