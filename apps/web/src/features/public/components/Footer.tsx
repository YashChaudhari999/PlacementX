        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 mb-16">
          <div className="md:col-span-4 lg:col-span-2 xl:col-span-2">
            ...
            <p className="text-sm text-slate-500 leading-relaxed max-w-xs mb-6">
              Intelligent Campus Placement Automation and Decision Support Platform designed for modern universities and ambitious students.
            </p>
            <div className="flex gap-4">
              <a href="#" className="text-slate-400 hover:text-primary transition-colors text-sm font-semibold">
                Twitter
              </a>
              <a href="#" className="text-slate-400 hover:text-primary transition-colors text-sm font-semibold">
                LinkedIn
          ...
          <div className="lg:col-span-1 xl:col-span-1">
            <h3 className="font-semibold text-sm tracking-wider text-slate-900 uppercase mb-5">Product</h3>
          ...
          <div className="lg:col-span-1 xl:col-span-1">
            <h3 className="font-semibold text-sm tracking-wider text-slate-900 uppercase mb-5">Company</h3>
            <ul className="space-y-3 text-sm text-slate-500">
          ...
          <div className="lg:col-span-1 xl:col-span-1">
            <h3 className="font-semibold text-sm tracking-wider text-slate-900 uppercase mb-5">Portals</h3>
            <ul className="space-y-3 text-sm text-slate-500">
          ...
          <div className="lg:col-span-1 xl:col-span-1">
            <h3 className="font-semibold text-sm tracking-wider text-slate-900 uppercase mb-5">Legal</h3>
            <ul className="space-y-3 text-sm text-slate-500">
