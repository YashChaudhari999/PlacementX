...
const features = [
 ...
 icon: <DatabaseIcon className="h-6 w-6 text-info"/>,
 ...
 icon: <EnergyIcon className="h-6 w-6 text-warning"/>,
 ...
 icon: <Shield01Icon className="h-6 w-6 text-success"/>,
...
export const FeaturesGrid = () => {
 ...
 className="group relative bg-card p-8 rounded-2xl border border-border shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
 >
 <div
