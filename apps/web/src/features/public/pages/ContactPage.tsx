...
export default function ContactPage() {
 ...
 >
 <div className="bg-card p-8 rounded-2xl border border-border shadow-xl relative z-20">
 ...
 <p className="text-muted-foreground text-sm">placements@nmims.edu</p>
 <p className="text-muted-foreground text-sm">support@placementx.com</p>
 </div>
 </div>
 ...
 <p className="text-muted-foreground text-sm">+91 (22) 4235 5555</p>
 ...
 >
 <div className="bg-card p-8 md:p-12 rounded-2xl border border-border shadow-xl relative z-20">
 {isSuccess ? (
 <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center">
 <div className="h-20 w-20 bg-green-100 text-success rounded-full flex items-center justify-center mb-6">
