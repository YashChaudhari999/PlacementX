...
export default function StudentLogin() {
 ...
 return (
 <div className="w-full min-h-screen flex bg-card">
 ...
 {/* Glowing Orbs */}
 <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-card/20 rounded-full blur-3xl z-0"/>
 ...
 <Link
 to="/"
 className="inline-flex items-center text-sm font-medium text-white/80 hover:text-white transition-colors bg-card/10 px-4 py-2 rounded-full backdrop-blur-md border border-white/10"
 >
 ...
 >
 <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-card text-primary mb-8 shadow-xl">
 <Mortarboard01Icon className="w-8 h-8"/>
 </div>
 <h1 className="text-4xl font-extrabold mb-6 leading-tight">
 Launch Your <br />
 <span className="text-blue-200">Dream Career</span>
 </h1>
 <p className="text-white/80 text-lg mb-10 leading-relaxed">
 Connect with top-tier companies, manage your placement journey, and unlock exclusive
 campus opportunities.
 </p>

 {/* Stats Highlights */}
 <div className="space-y-4">
 <div className="flex items-center gap-4 bg-card/10 p-4 rounded-2xl backdrop-blur-md border border-white/10">
 ...
 <div className="w-full lg:w-7/12 flex items-center justify-center p-8 sm:p-12 relative bg-muted">
 <div className="w-full max-w-md">
 <motion.div
 initial={{ opacity: 0, x: 20 }}
 animate={{ opacity: 1, x: 0 }}
 transition={{ duration: 0.4 }}
 className="bg-card p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-border"
 >
 <div className="mb-8 text-center">
 <h2 className="text-2xl font-bold text-foreground tracking-tight mb-2">
 Student Portal
 </h2>
 <p className="text-muted-foreground text-sm">Sign in with your university credentials.</p>
 </div>
 ...
 className="mb-6 bg-destructive-muted border border-red-200 text-destructive px-4 py-3 rounded-lg text-sm flex items-start gap-3"
 >
 ...
 required
 className="h-12 border-border text-foreground placeholder:text-muted-foreground focus-visible:ring-primary bg-muted/50 rounded-xl"
 />
 </FieldWrapper>
 ...
 id="remember-me"
 name="remember-me"
 className="border-border data-[state=checked]:bg-primary data-[state=checked]:border-primary rounded text-primary focus:ring-primary"
 />
 ...
 <Button
 variant="outline"
 className="w-full h-12 font-medium bg-card hover:bg-muted text-foreground border-border rounded-xl shadow-sm transition-all"
 >
 <svg
