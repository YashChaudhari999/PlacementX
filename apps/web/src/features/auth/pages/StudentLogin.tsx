          ...
          >
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="flex items-center">
                    <Checkbox
                      id="remember-me"
                      name="remember-me"
                      className="border-slate-300 data-[state=checked]:bg-primary data-[state=checked]:border-primary rounded text-primary focus:ring-primary"
                    />
            ...
            <div className="mt-8">
              ...
              <div className="mt-6">
                <Button
                  variant="outline"
                  className="w-full h-12 font-medium bg-white hover:bg-slate-50 text-slate-700 border-slate-200 rounded-xl shadow-sm transition-all"
                >
                  <svg
                    className="w-5 h-5 mr-3 text-slate-800"
                    viewBox="0 0 21 21"
