...
export default function Login() {
 ...
 {/* Decorative circles */}
 <div className="absolute -top-24 -left-24 w-72 h-72 rounded-full bg-card/5"/>
 <div className="absolute -bottom-24 -right-24 w-96 h-96 rounded-full bg-card/5"/>
 <div className="absolute top-1/3 -right-10 w-40 h-40 rounded-full bg-card/5"/>
 ...
 animate={{ opacity: 1, y: 0 }}
 className="mb-5 bg-destructive-muted border border-red-200 text-destructive px-4 py-3 rounded-lg text-sm"
 >
 {error}
 </motion.div>
 )}
 ...
 className="w-full h-12 px-4 border border-gray-200 rounded-lg text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#C8102E]/40 focus:border-[#C8102E] transition-all bg-gray-50 focus:bg-white"
 />
 </div>
 ...
 className="w-full h-12 px-4 border border-gray-200 rounded-lg text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#C8102E]/40 focus:border-[#C8102E] transition-all bg-gray-50 focus:bg-white pr-10"
 />
 <button
 type="button"
