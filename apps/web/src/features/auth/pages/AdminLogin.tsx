...
export default function AdminLogin() {
 ...
 <div className="bg-card/10 backdrop-blur-md border border-white/10 p-4 rounded-xl">
 ...
 <p className="text-muted-foreground">Sign in to manage placement operations.</p>
 </div>
